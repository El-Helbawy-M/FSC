...
extension Localization on String {
  ...
  static var _t = Translations("en") +
      ...
      } +
      {
        ...
        "ar": "حدد الوزن والحجم تقريباً",
        "ko": "패키지 매개 변수"
      } +
      {
        "en": "Order Weight",
        "fr": "Poids de la commande",
        "es": "Peso del pedido",
        "de": "Bestellgewicht",
        "pt": "Peso do pedido",
        "ar": "وزن الطلب",
      ...
      {"en": "Order Delivery Service", "ar": "خدمة توصيل الطلبات"} +
      {"en": "Order Details", "ar": "تفاصيل الطلب"} +
      {"en": "Drop Off:", "ar": "توصيل إلى:"};
