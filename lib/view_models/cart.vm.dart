            ...
            child: Column(
              ...
              children: <Widget>[
                VxStepper(
                    ...
                    defaultValue: cartItems[index].selectedQty ?? 1,
                    min: 1,
                    max: cartItems[index].product.availableQty ?? 20,
                    disableInput: true,
                    onChange: (value) {
                      //
                      cartItems[index].selectedQty = value;
                      CartServices.saveCartItems(cartItems);
                    }),
              ],
            ),
          ),
