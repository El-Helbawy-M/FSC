...
class AddressSearchView extends StatefulWidget {
  ...
  final Function(AutocompletePrediction) addressSelected;
...
class _AddressSearchViewState extends State<AddressSearchView> {
  ...
  void initState() {
    ...
    super.initState();
    googlePlace = GooglePlace(AppStrings.googleMapApiKey);
  }
    ...
    return VStack(
      [
        ...
        TextFormField(
          ...
          // getPlaceDetailWithLatLng: (AutocompletePrediction prediction) {
          ...
          // itmClick: (AutocompletePrediction prediction) {
          //   // //
