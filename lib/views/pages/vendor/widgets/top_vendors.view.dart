    ...
    return ViewModelBuilder<TopVendorsViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return VStack(
          [
            //
            "Top Vendors".i18n.text.xl.semiBold.make().p12(),
            // HStack(
            //   [
            //     .expand(),
            //     //
            ...
            //       color: model.selectedType == 1 ? AppColor.primaryColor : Colors.grey.shade600,
            //     ).px8(),
            //     //
            //     CustomButton(
            //       title: "Pickup".i18n,
            ...
            //         color: Colors.white,
            //       ),
            //       color: model.selectedType == 2 ? AppColor.primaryColor : Colors.grey.shade600,
            ...
            CustomListView(
              ...
              // childAspectRatio: AppStrings.enableGroceryMode ? 3.80 : 3.95,
              dataLength: model.vendors.length,
